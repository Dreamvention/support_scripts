...
$path = preg_match($pathRegEx, isset($_GET['path'])) ? '.' : $_GET['path'];
$pathURL = escape($path);
...
function doAuth(){
	...
	if ($do && isset($_SESSION['pwd']) && $_SESSION['pwd'] != PASSWORD)
		exit('Please refresh the page and login');
	if (isset($_SESSION['pwd']) && $_SESSION['pwd'] != PASSWORD)
		exit ('<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
