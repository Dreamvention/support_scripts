...
<tr><th>',lang(31),'<td>',html_select("auth[driver]",$Yb,DRIVER),'<tr><th>',lang(32),'<td><input name="auth[server]" value="',h(DB_HOSTNAME),'" title="hostname[:port]" placeholder="localhost" autocapitalize="off">
<tr><th>',lang(33),'<td><input name="auth[username]" id="username" value="',h(DB_USERNAME),'" autocapitalize="off">
<tr><th>',lang(34),'<td><input type="password" name="auth[password]" value="',DB_PASSWORD,'">
<tr><th>',lang(35),'<td><input name="auth[db]" value="',h(DB_DATABASE),'" autocapitalize="off">
</table>
